...
def test_intrusion_builder():
    ...
    intrusion_builder.lateral_extent_model = (
        rectangle_function  # intrusion_lateral_extent_model
    )
    intrusion_builder.vertical_extent_model = (
        parallelepiped_function  # intrusion_vertical_extent_model
    )
