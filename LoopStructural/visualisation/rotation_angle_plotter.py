...
class RotationAnglePlotter:
    ...
    def add_limb_svariogram(self, symb='bo', **kwargs):
        ...
        if svariogram:
            svariogram.calc_semivariogram()
            self.plot(svariogram.lags, svariogram.variogram, 1, 0, symb,**kwargs)
    ...
    def add_fold_axis_data(self, symb='bo',**kwargs):
        ...
        self.plot(fold_frame, rotation, 0, 0, symb,**kwargs)
    ...
    def add_fold_axis_curve(self, symb='r-',**kwargs):
        ...
        self.plot(x,self.feature.fold.fold_axis_rotation(x), 0, 0, symb,**kwargs)
