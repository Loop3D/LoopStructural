...
def contact_pts_using_geometric_scaling(thickness, points_df, inflation_vector):
    ...
    translation_vector = (inflation_vector / np.linalg.norm(
        inflation_vector,axis=1).reshape(1,len(inflation_vector)).T
        )*thickness
