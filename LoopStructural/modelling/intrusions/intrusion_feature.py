...
class IntrusionFeature(BaseFeature):
    ...
    def __init__(
        ...
        interpolator,
        # faults=[],
        name="UnnamedIntrusion", model=None):
    ...
    # @property
    # def lateral_extent_input_data(self):
    #     self.builder.up_to_date()
    #     return self.builder.data_for_lateral_extent_calculation

    # @property
    # def vertical_extent_input_data(self):
    #     self.builder.up_to_date()
    #     return self.builder.data_for_vertical_extent_calculation
