...
from LoopStructural.interpolators.structured_grid_3d import StructuredGrid
from LoopStructural.interpolators.structured_grid_2d import StructuredGrid2D
