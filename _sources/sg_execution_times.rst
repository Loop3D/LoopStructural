...
Computation times
=================
**10:34.094** total execution time for 17 files **from all galleries**:
...
.. container::
   ...
   * - :ref:`sphx_glr__auto_examples_1_basic_plot_1_data_prepration.py` (``../../examples/1_basic/plot_1_data_prepration.py``)
     - 00:00.804
     - 0.0
   * - :ref:`sphx_glr__auto_examples_3_fault_plot_update_fault_geometry.py` (``../../examples/3_fault/plot_update_fault_geometry.py``)
     - 00:00.651
     - 0.0
