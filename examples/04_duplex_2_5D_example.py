...
viewer.plot_isosurface(fault_frame2.features[0], isovalue=0, colour='black')
viewer.plot_isosurface(fault_frame.features[0], isovalue=0, colour='pink')
viewer.plot_isosurface(structural_frame2.features[0].feature, isovalue=0, colour='black')
...
viewer.plot_isosurface(faulted_strati.hw_feature, slices=slices, colour='green')
viewer.plot_isosurface(faulted_strati.parent_feature.fw_feature, slices=slices,  colour='blue')
viewer.plot_isosurface(faulted_strati.parent_feature.hw_feature, slices=slices,  colour='red')
