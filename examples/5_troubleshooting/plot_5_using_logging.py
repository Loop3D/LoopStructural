...
# Logging to console
# ~~~~~~~~~~~~~~~~~~
# It is also possible to change the logging level for the console log. This will help you to
# identify what the model is doing at different stages of the model building process.
