Introduction
------------
The examples in this section provide a starting point for users new to LoopStructural. 
...
You'll learn how to load structural data, such as orientation measurements, contact and fault locations, and use them to generate implicit 3D models of geological structures. 
